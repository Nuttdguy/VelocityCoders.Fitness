...
namespace VelocityCoders.FitnessPractice.Models
{
    ...
    {
        //notes:    This one just makes sure there are characters before and after the @
        public static string SimpleEmailPattern1 = @".+@.+";

        //notes:    This one makes sure the are characters before and after the @ as well as a character before
        //          and after the . in the domain.
